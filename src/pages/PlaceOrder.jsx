...
function PlaceOrder() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg space-y-6 mt-16 px-10">
            ...
            <h2 className="text-3xl font-semibold text-center text-primary-600">Complete Your Order</h2>
            ...
            <div className="border-t-2 border-primary-100 pt-6">
                <h3 className="text-xl font-medium  text-primary-500">Shipping Information</h3>
                <form action="#" method="POST" className="space-y-4 mt-4">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <label htmlFor="street" className="block text-sm font-medium text-gray-700">Street Address</label>
                            <input type="text" id="street" name="street" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                        </div>
                        <div>
                            <label htmlFor="city" className="block text-sm font-medium text-gray-700">City</label>
                            <input type="text" id="city" name="city" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                        </div>
                    </div>

                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <label htmlFor="state" className="block text-sm font-medium text-gray-700">Known Place</label>
                            <input type="text" id="state" name="state" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                        </div>
                        <div>
                            <label htmlFor="postalCode" className="block text-sm font-medium text-gray-700">Postal Code</label>
                            <input type="text" id="postalCode" name="postalCode" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                        </div>
                    </div>

                    <div>
                        <label htmlFor="country" className="block text-sm font-medium text-gray-700">Country</label>
                        <input type="text" id="country" name="country" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                    </div>
                </form>
            </div>
            ...
            {/* <!-- Payment Information --> */}
            <div className="border-t-2 border-primary-100 pt-6">
                <h3 className="text-xl font-medium  text-primary-500">Payment Method</h3>
                <form action="#" method="POST" className="space-y-4 mt-4">
                    ...
                    <div id="creditCardForm" className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="cardNumber" className="block text-sm font-medium text-gray-700">Card Number</label>
                                <input type="text" id="cardNumber" name="cardNumber" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                            </div>
                            <div>
                                <label htmlFor="cvv" className="block text-sm font-medium text-gray-700">Card Holder</label>
                                <input type="text" id="cvv" name="cvv" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="expiryDate" className="block text-sm font-medium text-gray-700">Expiry Date</label>
                                <input type="text" id="expiryDate" name="expiryDate" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required />
                            </div>
                            <div>
                    ...
                    {/* <!-- Payment Form for PayPal & Bank Transfer --> */}
                    <div id="paypalBankForm" className="hidden space-y-4">
                        <p className="text-sm text-gray-600">You will be redirected to the respective payment platform after order confirmation.</p>
                    </div>

                    {/* <!-- Submit Button --> */}
                    <button type="submit" className="w-full px-6 py-3 text-white bg-primary-500 hover:bg-primary-600 rounded-lg font-semibold focus:outline-none focus:ring-2 focus:ring-primary-500">
                        Confirm Order
                    </button>
                </form>
            </div>
